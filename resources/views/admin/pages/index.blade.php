            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="btn-group">
                                <a href="{{ action('Admin\PagesController@create') }}" class="btn sbold green ">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a href="{{ action('Admin\PagesController@edit' ,  $data->id) }}" class="btn sbold blue ">
                            ...
                            <td>
                                ...
                                @else
                                    <a href="{{ action('Admin\PagesController@destroyPage' , $data->id) }}" class="btn sbold red ">
