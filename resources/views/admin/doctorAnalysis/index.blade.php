            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="btn-group">
                                <a href="{{ action('Admin\DrugsController@create') }}" class="btn sbold green ">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                    ...
                    <tbody>
                    <?php $allDoctor = \App\UserWeb::where('type' , 1)->get(); ?>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a href="{{ action('Admin\DrugsController@delDrugs' , $data->id) }}" class="btn sbold red ">
