<div class="col-md-3 col-sm-4">
    <ul class="usernavdash">
        <li class="{{ request()->segment(1) == 'home'?'active':''}}">
            <a href="#"><i class="fa fa-tachometer" aria-hidden="true"></i> الرئيسيه</a></li>
        ...
        <li class="{{ request()->segment(1) == 'viewpatients'?'active':''}}"><a href="{{url('/viewpatients/'.auth('users-web')->user()->id)}}"><i class="fa fa-users" aria-hidden="true"></i> المرضى</a></li>
        ...
        <li class="{{ request()->segment(1) == 'Rotchta'?'active':''}}"><a href="{{url('/Rotchta/'.auth('users-web')->user()->id)}}"><i class="fa fa-copy" aria-hidden="true"></i> الروشته</a></li>
        {{--<li class="{{ request()->segment(1) == 'Rotchta'?'active':''}}"><a href="{{url('/Rotchta/'.auth('users-web')->user()->id)}}"><i class="fa fa-copy" aria-hidden="true"></i> الروشته2</a></li>--}}
        <li><a href="{{ URL('logoutuser' ) }}"><i class="fa fa-copy" aria-hidden="true"></i> تسجيل خروج</a></li>
    </ul>
</div>